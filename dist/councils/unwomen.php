...
<img class="h-28 mx-auto" src="/images/councils/unwomen.webp">

<?php include __DIR__.'/../councilside.php'; ?>

    <div class="lg:w-full mx-4 lg:mx-32">
        <div class="font-display text-3xl pt-24 text-center">United Nations Entity for Gender Equality and the Empowerment of Women</div>
        ...
        <div class="flex flex-wrap ">
           ...
           <div class="py-4 pb-8 lg:py-10 lg:mx-14 grow text-justify lg:w-0 mb-20">
                ...
                <div class="font-display text-xl text-left py-4 pt-12">Topic 1: Promoting a Holistic and Ethical Reproductive Health Education</div>
                <div class="text-justify"></div>
                <div class="font-display text-xl text-left py-4 pt-12">Topic 2: The Impact of the Russia-Ukrainian War on Women's Rights</div>
                <div class="text-justify"></div>
            </div>
        </div>

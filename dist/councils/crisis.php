...
<img class="h-28 mx-auto" src="/images/councils/crisis.webp">

<?php include __DIR__.'/../councilside.php'; ?>

    <div class="lg:w-full mx-4 lg:mx-32">
        <div class="font-display text-3xl pt-24 text-center">Crisis Council</div>
        ...
        <div class="flex flex-wrap ">
           ...
           <div class="py-4 pb-8 lg:py-10 lg:mx-14 grow text-justify lg:w-0 mb-20">
                ...
                <div class="font-display text-xl text-left py-4 pt-12">Topic 1: 2025: China's Invasion of Taiwan</div>
